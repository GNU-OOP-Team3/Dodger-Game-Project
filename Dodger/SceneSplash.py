...
class SceneSplash(pyghelpers.Scene):
    def __init__(self, window):
        ...
        self.backgroundImage = pygwidgets.Image(self.window,
                                                (0, 0), '/Users/gimtaehun/PycharmProjects/PythonProject/Object-Oriented-Python-Code/Chapter_16/Dodger/images/gameBack.png')
        self.dodgerImage = pygwidgets.Image(self.window,
                                                (150, 30), 'images/dodger.png')

        self.startButton = pygwidgets.CustomButton(self.window, (200, 610),
