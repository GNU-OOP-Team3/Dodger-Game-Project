...
class Baddie():
    ...
    BADDIE_IMAGE = pygame.image.load('/Users/gimtaehun/PycharmProjects/PythonProject/Object-Oriented-Python-Code/Chapter_16/Dodger/images/fGrade.png')
    ...
    def __init__(self, window):
        ...
        # Scale it
        percent = (size*50) / Baddie.MAX_SIZE
