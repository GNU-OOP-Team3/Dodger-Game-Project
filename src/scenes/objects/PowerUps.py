...
class PowerUp:
    ...
    IMAGE_FILE = f'{RESOURCES_PATH}/images/goodie.png'  # 기본 이미지
...
pwu_PATH = f"{RESOURCES_PATH}/images/powerUps"

class Score2X(PowerUp):
    IMAGE_FILE = f'{pwu_PATH}/goodie_double.png'
    TYPE = 'score_x2'
...
class SlowMotion(PowerUp):
    IMAGE_FILE = f'{pwu_PATH}/goodie_slow.png'
    TYPE = 'slow'
...
class Invincibility(PowerUp):
    IMAGE_FILE = f'{pwu_PATH}/goodie_invincibility.png'
    TYPE = 'invincible'
    DURATION = 300
